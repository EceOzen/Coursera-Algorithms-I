...
public class Percolation {
    ...
    public void open(int row, int col) {
        ...
        // Check and Open Left
        if (validateGrid(row, col - 1) && isOpen(row, col - 1)) {
        ...
        // Check and Open Up
        if (validateGrid(row - 1, col) && isOpen(row - 1, col)) {
    ...
    private boolean validateGrid(int row, int col) {
    	int rowShifted = row - 1;
        int colShifted = col - 1;
        
        return (rowShifted >= 0 && colShifted >= 0 && rowShifted < gridSize && colShifted < gridSize);
    }
